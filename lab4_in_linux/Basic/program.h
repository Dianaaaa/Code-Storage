 ...
 * Usage: program.addSourceLine(lineNumber, line, state);
 * -----------------------------------------------
 ...
 */
   ...
   void addSourceLine(int lineNumber, std::string line, EvalState & state);
...
private:
  map<int,shared_ptr<Statement>> statements;
